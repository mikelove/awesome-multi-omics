...
- 2017 - [mixOmics](https://bioconductor.org/packages/mixOmics) - Rohart - various methods [paper 1](https://doi.org/10.1371/journal.pcbi.1005752), DIABLO: Data Integration Analysis for Biomarker discovery using Latent cOmponents [paper 2](https://doi.org/10.1093/bioinformatics/bty1054)
